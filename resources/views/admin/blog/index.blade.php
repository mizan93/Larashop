                ...
                <div class="col-md-12 text-left">
                    ...
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title">All blog <span class="badge badge-info display-4">{{ $blogs->count()}}</span></h4>
                        </div>
                            ...
                            <table id="example2" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    @foreach($blogs as $key=>$blog)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td><img src="{{ url('storage/blog/'.$blog->image) }}" alt="Image" class="img-fluid" style="width: 80px; height:60px;" srcset=""></td>
                                            ...
                                            <td>
                                                ...
                                                <form id="delete-form-{{ $blog->id }}" action="{{ route('admin.blog.destroy',$blog->id) }}" style="display: none;" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
